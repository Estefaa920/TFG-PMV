...
describe('Aforo Management Component', () => {
  let comp: AforoComponent;
  let fixture: ComponentFixture<AforoComponent>;
  let service: AforoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'aforo', component: AforoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(AforoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.aforos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
