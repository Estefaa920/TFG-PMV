...
describe('Butaca Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'butaca', component: ButacaComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.butacas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
