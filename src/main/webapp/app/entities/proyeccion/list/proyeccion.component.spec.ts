...
describe('Proyeccion Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'proyeccion', component: ProyeccionComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.proyeccions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
