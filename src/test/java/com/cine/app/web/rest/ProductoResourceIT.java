...
import com.cine.app.domain.Producto;
import com.cine.app.repository.ProductoRepository;
...
class ProductoResourceIT {
    ...
    public static Producto createEntity(EntityManager em) {
        Producto producto = new Producto().nombre(DEFAULT_NOMBRE).precio(DEFAULT_PRECIO).cantidad(DEFAULT_CANTIDAD);
        return producto;
    }
    ...
    public static Producto createUpdatedEntity(EntityManager em) {
        Producto producto = new Producto().nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).cantidad(UPDATED_CANTIDAD);
        return producto;
    }
    ...
    void putNewProducto() throws Exception {
        ...
        updatedProducto.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).cantidad(UPDATED_CANTIDAD);
    ...
    void fullUpdateProductoWithPatch() throws Exception {
        ...
        partialUpdatedProducto.nombre(UPDATED_NOMBRE).precio(UPDATED_PRECIO).cantidad(UPDATED_CANTIDAD);
